...
abstract class DAO
{
     ...
     */
    final protected function paginacao($entity, $criteria, $limit, $extraBindValue = null, $page = null, $limitePage = null)
    {
    ...
    protected function totalPages ($entity, $criteria, $limit = null, $extraBindValue = null, $page = null, $limitePage = null)
    {
        //array que armazenara o resultado
        $paginacao = array();
        //cria uma instrucao de select
